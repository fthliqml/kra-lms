          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white shadow-all rounded-xl p-6 space-y-3">
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                konsep modern seperti arrow function, modul ES6, serta
                pemrograman asinkron menggunakan promise dan async/await. Materi
                mencakup manipulasi DOM, penanganan event, dan pengembangan
                logika interaktif untuk aplikasi web. Kursus ini dirancang untuk
                membekali Anda dengan keterampilan JavaScript yang aplikatif,
                baik di sisi klien maupun server, serta siap digunakan dalam
                proyek nyata dan proses rekrutmen.
              </p>
            </div>
